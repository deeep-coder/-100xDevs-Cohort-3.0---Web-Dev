...
const users = [{
    name: "John",
    kidneys: [{
        healthy: false                              //false matlab bad kidney mtlab kharab and true matlab good kidney
    }]
}];
...
app.get("/", function(req, res) {                   //yeh get karr rha hai
    ...
    const numberOfKidneys = johnKidneys.length;     //phir kidneys ke length tak isko initialize kara
    let numberOfHealthyKidneys = 0;                 //man liya at first ki sari kidneys sahi hai isliye 0 initilize kara 
